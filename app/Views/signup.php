...
<body>
    ...
    <div class="signin">
      ...
      <div class="content">
        ...
        <h2>Sign In</h2>
    <form class="form-control" action="/signupStore" method="post">
        <?= csrf_field() ?>
            <div class="form">
           ...
           <!-- <div class="inputBox">
            ...
            <div class="links"> <a href="#" style="color: #0f0">Already have an account!</a> <a href="<?php echo base_url('/') ?>">Login</a>
